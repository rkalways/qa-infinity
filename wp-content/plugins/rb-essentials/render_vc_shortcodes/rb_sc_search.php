...
function rb_vc_shortcode_sc_search ( $atts = array(), $content = "" ){
	$defaults = array(
		/* -----> GENERAL TAB <----- */
		"label"						=> "Search",
		"el_class"					=> "",
	...
	$out .= "<div id='".$id."' class='rb_search_module". ( !empty($el_class) ? " $el_class" : "" ) ."'>";
...
add_shortcode( 'rb_sc_search', 'rb_vc_shortcode_sc_search' );
