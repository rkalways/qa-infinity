...
class RB_About extends WP_Widget {
	public function __construct() {
		$widget_options = array( 
		  'classname' => 'rb_about',
		  'description' => esc_html_x('Displays custom "RB About" widget', 'Widget RB-About', 'seoes'),
		);
	...
	public function form( $instance ) {
		$title = !empty( $instance['title'] ) ? $instance['title'] : esc_html_x( 'New widget', 'Widget RB-About', 'seoes' ); 
		$name = !empty( $instance['name'] ) ? $instance['name'] : esc_html_x( 'John Doe', 'Widget RB-About', 'seoes' );
		$description = !empty( $instance['description'] ) ? $instance['description'] : esc_html_x( 'Lorem ipsum dolor sit amet', 'Widget RB-About', 'seoes' );
		?>
		
		<div class='widget-row'>
			<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>">
				<?php echo esc_html_x( 'Title:', 'Widget RB-About', 'seoes' ); ?>
			</label>
		...
		<div class='widget-row'>
	        <label for="<?php echo $this->get_field_id( 'image_1' ); ?>">
	        	<?php echo esc_html_x( 'Image:', 'Widget RB-About', 'seoes' ); ?>
	        </label>
	        <div class="widget-inner-content img-inside">
		        ...
		        <button type="button" id="<?php echo $this->get_field_id( 'image_1' ) ?>" class="button js_custom_upload_media<?php echo empty($instance['image_1']) ? ' empty' : ''; ?>"><?php echo esc_html_x('No file selected', 'Widget RB-About', 'seoes') ?></button>
	    ...
	    <div class='widget-row'>
			<label for="<?php echo $this->get_field_id( 'name' ) ?>">
				<?php echo esc_html_x( 'Name:', 'Widget RB-About', 'seoes' ); ?>
			</label>
			<div class="widget-inner-content">
	    ...
	    <div class='widget-row'>
	    	<label for="<?php echo esc_attr( $this->get_field_id( 'description' ) ) ?>">
				<?php echo esc_html_x( 'Description:', 'Widget RB-About', 'seoes' ); ?>
			</label>
			<div class="widget-inner-content">
	    ...
	    <div class='widget-row'>
	        <label for="<?php echo $this->get_field_id( 'image_2' ); ?>">
	        	<?php echo esc_html_x( 'Signature:', 'Widget RB-About', 'seoes' ); ?>
	        </label>
	        <div class="widget-inner-content img-inside">
		        ...
		        <button type="button" id="<?php echo $this->get_field_id( 'image_2' ) ?>" class="button js_custom_upload_media<?php echo empty($instance['image_2']) ? ' empty' : ''; ?>"><?php echo esc_html_x('No file selected', 'Widget RB-About', 'seoes') ?></button>
