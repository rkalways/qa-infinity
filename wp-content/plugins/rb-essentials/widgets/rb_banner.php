...
class RB_Banner extends WP_Widget{
	public function __construct() {
		$widget_options = array( 
		  'classname' => 'rb_banner',
		  'description' => esc_html_x('Displays custom "RB Banner" widget', 'Widget RB-Banner', 'seoes'),
		);
	...
	public function form( $instance ) {
		...
		<div class='widget-row'>
			<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>">
				<?php echo esc_html_x( 'Title:', 'Widget RB-Banner', 'seoes' ); ?>
			</label>
		...
		<div class='widget-row'>
	        <label for="<?php echo $this->get_field_id( 'bg' ); ?>">
	        	<?php echo esc_html_x( 'Background:', 'Widget RB-Banner', 'seoes' ); ?>
	        </label>
	        <div class="widget-inner-content img-inside">
		        ...
		        <button type="button" id="<?php echo $this->get_field_id( 'bg' ) ?>" class="button js_custom_upload_media<?php echo empty($instance['bg']) ? ' empty' : ''; ?>"><?php echo esc_html_x('No file selected', 'Widget RB-Banner', 'seoes') ?></button>
	    ...
	    <div class='widget-row'>
			<label for="<?php echo $this->get_field_id( 'content_title' ) ?>">
				<?php echo esc_html_x( 'Content Title:', 'Widget RB-Banner', 'seoes' ); ?>
			</label>
			<div class="widget-inner-content">
	    ...
	    <div class='widget-row'>
	    	<label for="<?php echo esc_attr( $this->get_field_id( 'description' ) ) ?>">
				<?php echo esc_html_x( 'Description:', 'Widget RB-Banner', 'seoes' ); ?>
			</label>
			<div class="widget-inner-content">
	    ...
	    <div class='widget-row'>
			<label for="<?php echo $this->get_field_id( 'url' ) ?>">
				<?php echo esc_html_x( 'URL:', 'Widget RB-Banner', 'seoes' ); ?>
			</label>
			<div class="widget-inner-content">
